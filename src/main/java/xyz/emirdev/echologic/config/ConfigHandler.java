...
public class ConfigHandler {
    private static final File DATA_FILE = new File(EchoLogic.getDataDirectory().toString() + "/config.yml");
    ...
    public ConfigHandler() {
        ...
        this.yamlFile.addDefault("database.name", "echologic");
    ...
    public RegisteredServer getHubServer() {
        ...
        if (hub.equals("none"))
            return null;
        Optional<RegisteredServer> server = EchoLogic.getProxy().getServer(hub);
